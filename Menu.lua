...
local Window = Library.CreateLib("    Swng Hub  - 1.01 alpha   ", "DarkTheme")

--WELCOME

local Tab = Window:NewTab("Welcome")
local Section = Tab:NewSection("SWNG Hub loaded!")
Section:NewLabel("Thanks for using! :)")
Section:NewLabel("Made By: SmallPreston#5311")
Section:NewLabel("Alpha 1.01! Updates: discord, key system with stage 10 cancer")
local Section = Tab:NewSection("version")
Section:NewLabel("alpha 1.00 ")
Section:NewLabel("me making this makes me feel like im developing")
Section:NewLabel("cancer")
Section:NewButton("kick gui", "real.", function()
